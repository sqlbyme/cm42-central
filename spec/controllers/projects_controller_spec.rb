      ...
      describe "collection actions" do
        describe "#index" do
          specify do
            ...
            expect(assigns[:projects_without_current_user]).to eq([another_project])
          end
        end
      end
    end
      ...
      describe "collection actions" do
        ...
        describe "#index" do
          ...
          specify do
            get :index
            expect(response).to be_success
            expect(assigns[:projects]).to eq(team.projects)
            expect(assigns[:projects_without_current_user]).to contain_exactly(another_project)
          end
